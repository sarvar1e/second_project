...
// console.log(mockPostData.map((a)=>a.id))
// console.log(mockPostData.filter((a) => a.userId > 9));
// console.log(mockPostData.map((a) => a.title));
console.log(mockPostData.map((a) => a.body));
