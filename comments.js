...
// console.log(mockCommentData.map((a)=>a.id))
// console.log(mockCommentData.filter((a) => a.userId > 2));
// console.log(mockCommentData.map((a) => a.body));
// console.log(mockCommentData.map((a) => a.email));
